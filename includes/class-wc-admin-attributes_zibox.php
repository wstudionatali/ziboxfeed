 ...
 */
class WC_Admin_Attributes_Zibox {
						...
						<table class="widefat attributes-table wp-list-table ui-sortable" style="width:100%">
							<thead>
								<tr>
									...
									<?php endif; ?>
									<th scope="col"><?php esc_html_e( 'Zibox ID', 'ziboxfeed' ); ?></th>
								...
								if ( $attribute_taxonomies ) :
									foreach ( $attribute_taxonomies as $tax ) :
										...
										<tr>
												...
												<?php endif;
												$ziboxid =$tax->zibox_attribute_id;
												if ($tax->zibox_attribute_id>0) {
												$ziboxid .='<img src="'.ZIBOX_URL.'image/choose-platform-logo.svg" width="40">';
												}
												
												?>
												<td><?php echo ( $ziboxid ); ?></td>
												<td>
